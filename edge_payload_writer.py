...
from growth_utils import source_date_field, source_date_value
...
def compact_job_payload(job_hash: str, job: Dict) -> Dict:
    ...
    source_published = source_date_value(job)
    return {
        "hash": job_hash,
        ...
        "source_date_field": _clean_text(source_date_field(job), 40),
